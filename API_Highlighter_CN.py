...
class BurpExtender(IBurpExtender, IHttpListener, ITab):
    def registerExtenderCallbacks(self, callbacks):
        ...
        callbacks.setExtensionName(decode_text("API Highlighter"))
    ...
    def init_ui(self):
        ...
        self._text_area.border = BorderFactory.createTitledBorder(decode_text("\u6279\u91cf\u5bfc\u5165\u0041\u0050\u0049"))
        ...
        self._import_button = JButton(decode_text("\u5bfc\u5165\u0041\u0050\u0049"), actionPerformed=self.import_apis)
        self._button_import_panel.add(self._import_button)
        self._button_import_panel.add(Box.createHorizontalStrut(10))
        self._precise_match_button = JCheckBox(decode_text("\u542f\u7528\u7cbe\u786e\u5339\u914d"))
        self._button_import_panel.add(self._precise_match_button)
        self._table_model = CustomTableModel([decode_text("\u65b9\u6cd5"), decode_text("\u0041\u0050\u0049"), decode_text("\u6ce8\u91ca"), decode_text("\u6d4b\u8bd5")], 0)
        ...
        self._remove_button = JButton(decode_text("\u5220\u9664\u0041\u0050\u0049"), actionPerformed=self.remove_api)
        self._button_panel.add(self._remove_button)
        self._toggle_tested_button = JButton(decode_text("\u5207\u6362\u6d4b\u8bd5\u72b6\u6001"), actionPerformed=self.toggle_tested)
        self._button_panel.add(self._toggle_tested_button)
        self._move_tested_to_top_button = JButton(decode_text("\u5c06\u5df2\u6d4b\u8bd5\u79fb\u81f3\u9876\u90e8"), actionPerformed=self.move_tested_to_top)
        self._button_panel.add(self._move_tested_to_top_button)
        self._filter_text = JTextArea(1, 10)
        self._filter_button = JButton(decode_text("\u67e5\u627e\u0041\u0050\u0049"), actionPerformed=self.find_api)
    ...
    def getTabCaption(self):
        return decode_text("API Highlighter")
